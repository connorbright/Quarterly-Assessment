...
# Create the DS4210 table to store the questions and answers
cursor.execute('''
...
# List of 10 questions and answers for the DS4210 Conflict Management and Negotiation course (question, options, correct answer)
questions = [
...
# Insert questions and answers into the DS4210 table
for question in questions:
    cursor.execute('''
    INSERT INTO DS4210 (question, option_a, option_b, option_c, option_d, correct_answer)
    VALUES (?, ?, ?, ?, ?, ?)
    ''', question)
...
cursor.execute('SELECT * FROM DS4210')
